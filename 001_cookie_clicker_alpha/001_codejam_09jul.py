...
def read_data(file):
    ...
    n_cases = cases[0][0]   # first row is number of cases
...
def win_elapsed_time(farm_cost, cookie_rate, win_cookies):
    ...
    while True:   # keep iterating until accumulating is faster than buying
        ...
        print('t_buy_farm = ' + str(t_buy_farm))
        print('t_win = ' + str(t_win))
        print('t_buy_farm_win = ' + str(t_buy_farm_win))
        if t_win > t_buy_farm_win:   # accumulating is slower. Buy another farm.
            ...
            elapsed_time += t_win
            break   # WIN!
        print('Current elapsed time: %f' % elapsed_time)
    return elapsed_time


cases = read_data('sample_ip.txt')
print('Number of rows in cases: ' + str(len(cases)))
case_num = 1   # case number counter: starts from 1 

#for case in cases:   # iterate over cases
#    print('Case #' + str(case_num) + ': ' + str(case))
#    farm_cost, cookie_rate, win_cookies = case[0], case[1], case[2]
#    print('farm cost: ' + str(farm_cost))
#    print('cookie_rate: ' + str(cookie_rate))
#    print('win_cookies: ' + str(win_cookies))
#    elapsed_time = win_elapsed_time(farm_cost, cookie_rate, win_cookies)
#    print('Case #%d elapsed time: %.7f secs' % (case_num, elapsed_time))   # print result with 7 decimal places
